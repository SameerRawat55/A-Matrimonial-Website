<?php
if (empty($_POST["status"]) || empty($_POST["gender"]) || empty($_POST["religion"]) || empty($_POST["caste"])) {
	...
	if (isset($_COOKIE["login"])) {
		...
		$rs = mysqli_query($conn, "select * from profile where status='$status' AND gender='$gender' AND caste='$caste'AND religion='$religion' AND email<>'$email'");
