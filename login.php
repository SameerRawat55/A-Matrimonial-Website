  ...
  <div class="container">
   ...
   <div class="services">
	   ...
	   <form method="post" action="check.php">
	      ...
	      <input type="email" id="edit-name" name="email" class="form-text required" required>
	    </div>
	    <div class="form-item form-type-password form-item-pass">
	      <label for="edit-pass">Password <span class="form-required" title="This field is required.">*</span></label>
	      <input type="password" id="edit-pass" name="pass" class="form-text required" required>
	    </div>
