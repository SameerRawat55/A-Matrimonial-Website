                        ...
                        <div class="col-sm-6 login_left">
                            ...
                            <form method="post" action="update.php">
                                <div class="form-group">
                                    ...
                                    <input type="text" id="edit-name" name="fname" class="form-text required" placeholder="Enter First Name" value="<?= $r["fname"] ?>">
                                </div>
                                <div class="form-group">
                                    <label for="edit-name">Last Name <span class="form-required" title="This field is required.">*</span></label>
                                    <input type="text" id="edit-name" name="lname" class="form-text required" placeholder="Enter Last Name" value="<?= $r["lname"] ?>">
                                </div>
                                <div class="form-group">
                                    <label for="edit-name">Email <span class="form-required" title="This field is required.">*</span></label>
                                    <input type="email" id="edit-name" name="email" class="form-text required" placeholder="Enter Email" value="<?= $r["email"] ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="edit-name" name="occupation" class="form-text required" placeholder="Enter Occupation" value="<?= $r["occupation"] ?>">
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="text" id="edit-name" name="city" class="form-text required" placeholder="Enter City" value="<?= $r["city"] ?>">
                                </div>
                                <div class="form-group">
                                    <label for="edit-name">State<span class="form-required" title="This field is required.">*</span></label>
                                    <input type="text" id="edit-name" name="state" class="form-text required" placeholder="Enter State" value="<?= $r["state"] ?>">
                                </div>
                                <div class="form-group">
                                    <label for="edit-name">Country<span class="form-required" title="This field is required.">*</span></label>
                                    <input type="text" id="edit-name" name="country" class="form-text required" placeholder="Enter Country" value="<?= $r["country"] ?>">
                                </div>
...
<?php
        ...
        header("location:profile.php?edit_again=1");
    }
} else {
