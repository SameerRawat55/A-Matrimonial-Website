                    ...
                    <div class="col-sm-6 login_left">
                        <form method="post" action="change_pass.php">
                            <div class="form-item form-type-password form-item-pass">
                                ...
                                <input type="text" id="edit-pass" name="cp" class="form-text required" required>
                            </div>
                            <div class="form-item form-type-password form-item-pass">
                                <label for="edit-pass">New Password<span class="form-required" title="This field is required.">*</span></label>
                                <input type="text" id="edit-pass" name="np" class="form-text required" required>
                            </div>
                            <div class="form-item form-type-password form-item-pass">
                                <label for="edit-pass">Confirm Password<span class="form-required" title="This field is required.">*</span></label>
                                <input type="text" id="edit-pass" name="rp" class="form-text required" required>
                            </div>
                            <div class="form-actions">
                                <input type="submit" id="edit-submit" name="op" value="Change" class="btn_1 submit">
                            </div>
                        </form>
                    </div>
                    <div class="col-sm-6">
